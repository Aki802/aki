...
def main(page: ft.Page):
    ...
    def clear_click(e):
        if count_column.controls:
            ...
            while dast!="TIME" and dast!="TOOL" and dast!="MOZI" and dast!="POSI" and dast!="LCLICK" and dast!="RCLICK" and dast!="ENTER" and dast!="DRDR" and dast!="COPY" and dast!="PASTE" and dast!="NEWXL" and dast!="VBA":
                dast = count.pop()
